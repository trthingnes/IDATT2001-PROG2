...
public class BonusMember {
   ...
   */
  public BonusMember(
      int memberNumber, LocalDate enrolledDate, String name, String emailAddress, String password) {
  ...
  /**
   * Checks if bonus point balance is high enough to upgrade membership. If it is, the membership
  ...
  public String toString() {
    return String.format(
        "%s<%s> (#%s): Enrolled: %s, Member status: %s, Point balance: %s",
        name,
        emailAddress,
        memberNumber,
